      ...
      <Container maxWidth="lg">
        <Grid container spacing={6} alignItems="center">
          ...
          <Grid item xs={12} md={6}>
            <CardMedia
              component="img"
              image="/src/media/aboutusimage.png" // Adjust the image path as needed
              alt="Academy Image"
          ...
          <Grid item xs={12} md={6}>
            <CardContent>
              <Typography variant="h3" component="h2" gutterBottom sx={{ fontWeight: 'bold', color: '#1d4f67' }}>
                About <span style={{ color: '#fffce8' }}>Athletify</span>
              </Typography>
              <Typography variant="body1" paragraph sx={{ color: '#4f5d75', lineHeight: 1.5, textAlign: 'justify', fontWeight:'400', fontSize:'20px', letterSpacing:'0' }}>
              ...
              <Typography variant="body1" paragraph sx={{ color: '#4f5d75', lineHeight: 1.5, textAlign: 'justify', fontSize:'20px' , letterSpacing:'0' }}>
